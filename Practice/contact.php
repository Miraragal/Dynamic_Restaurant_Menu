<?php
define('TITLE', "Milo's CONTACT US");
...
<div id='contact'>
    ...
    if (isset($_POST['contact_submit'])) {
        ...
        // ***   Send authomatic emails after submission  ***  
        ...
        $message = wordwrap($message, 72); //Keep message neat in n' tidy
    ...
    <?php } else { ?>
        ...
        <form method="post" action="" id="contact-form" style='text-align:left'>
